...
{	int j, h = now._nr_pr;
	...
	case 0:	/* Cars */
		...
		/* params: */
		/* locals: */
		((P0 *)pptr(h))->_1_1_tempDown = 0;
		((P0 *)pptr(h))->_1_1_tempUp = 0;
		((P0 *)pptr(h))->_1_2_tempDown = 0;
		((P0 *)pptr(h))->_1_2_tempUp = 0;
#ifdef VAR_RANGES
		logval("Cars:tempDown", ((P0 *)pptr(h))->_1_1_tempDown);
		logval("Cars:tempUp", ((P0 *)pptr(h))->_1_1_tempUp);
		logval("Cars:tempDown", ((P0 *)pptr(h))->_1_2_tempDown);
		logval("Cars:tempUp", ((P0 *)pptr(h))->_1_2_tempUp);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
...
{	/* int i; */
	...
	case 1:
		...
		break;
	case 0:
		printf("local vars proc %d (Cars):\n", pid);
	printf("	int    tempDown:	%d\n", ((P0 *)pptr(pid))->_1_1_tempDown);
	printf("	int    tempUp:	%d\n", ((P0 *)pptr(pid))->_1_1_tempUp);
	printf("	int    tempDown:	%d\n", ((P0 *)pptr(pid))->_1_2_tempDown);
	printf("	int    tempUp:	%d\n", ((P0 *)pptr(pid))->_1_2_tempUp);
		break;
	}
}
void
