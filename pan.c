...
{	int j, h = now._nr_pr;
	...
	case 0:	/* Cars */
		...
		/* params: */
		/* locals: */
		((P0 *)pptr(h))->_1_1_tmp = 0;
		((P0 *)pptr(h))->_1_2_tmp = 0;
#ifdef VAR_RANGES
		logval("Cars:tmp", ((P0 *)pptr(h))->_1_1_tmp);
		logval("Cars:tmp", ((P0 *)pptr(h))->_1_2_tmp);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
...
{	/* int i; */
	...
	printf("	int    tmp:	%d\n", ((P0 *)pptr(pid))->_1_1_tmp);
	printf("	int    tmp:	%d\n", ((P0 *)pptr(pid))->_1_2_tmp);
		break;
	}
}
void
